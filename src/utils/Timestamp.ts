...
import { Timestamp, NumberArray } from '../types/timestamp'
 ...
 */
export function getStartOfWeek(timestamp: Timestamp, weekdays: NumberArray, today: Timestamp) {
 ...
 */
export function getEndOfWeek(timestamp: Timestamp, weekdays: NumberArray, today: Timestamp) {
 ...
 */
export function getStartOfMonth(timestamp: Timestamp) {
 ...
 */
export function getEndOfMonth(timestamp: Timestamp) {
...
export function parseTime(input: any) {
 ...
 */
export function validateTimestamp(input: any) {
 ...
 */
export function compareTimestamps(ts1: Timestamp, ts2: Timestamp) {
 ...
 */
export function compareDate(ts1: Timestamp, ts2: Timestamp) {
 ...
 */
export function compareTime(ts1: Timestamp, ts2: Timestamp) {
 ...
 */
export function compareDateTime(ts1: Timestamp, ts2: Timestamp) {
 ...
 */
export function parsed(input: string) {
 ...
 */
export function parseTimestamp(input: string, now: Timestamp) {
 ...
 */
export function getDayIdentifier(timestamp: Timestamp) {
 ...
 */
export function getTimeIdentifier(timestamp: Timestamp) {
 ...
 */
export function getDayTimeIdentifier(timestamp: Timestamp) {
 ...
 */
export function diffTimestamp(ts1: Timestamp, ts2: Timestamp, strict?: boolean) {
 ...
 */
export function updateRelative(timestamp: Timestamp, now: Timestamp, time = false) {
 ...
 * @returns {Timestamp} The updated {@link Timestamp}
 */
export function updateMinutes(timestamp: Timestamp, minutes: number, now: Timestamp) {
 ...
 */
export function updateWeekday(timestamp: Timestamp) {
 ...
 * @returns The modified Timestamp
 */
export function updateDayOfYear(timestamp: Timestamp) {
  timestamp.doy = getDayOfYear(timestamp) as number
 ...
 */
export function updateWorkWeek(timestamp: Timestamp) {
 ...
 * @returns The modified {@link Timestamp}
 */
export function updateDisabled(timestamp: Timestamp, disabledBefore: string, disabledAfter: string, disabledWeekdays: NumberArray, disabledDays: string[]) {
 ...
 */
export function createNativeLocaleFormatter(locale: string, cb: (t: any, v: any) => any) {
 ...
 */
export function makeDate(timestamp: Timestamp) {
 ...
 * @returns {date} A JavaScript Date
 */
export function makeDateTime(timestamp: Timestamp) {
 ...
 */
export function isBetweenDates(timestamp: Timestamp, startTimestamp: Timestamp, endTimestamp: Timestamp, useTime: boolean/* = false */) {
 ...
 */
export function isOverlappingDates(startTimestamp: Timestamp, endTimestamp: Timestamp, firstTimestamp: Timestamp, lastTimestamp: Timestamp) {
 ...
 */
export function addToDate(timestamp: Timestamp, options: Object) {
  const ts = copyTimestamp(timestamp)
  let minType: number
...
// addToDate helper
function __forEachObject(obj: any, cb: (arg0: any, arg1: any) => void) {
  Object.keys(obj).forEach(k => cb(obj[k], k))
}

// normalize minutes
function __normalizeMinute(ts: Timestamp) {
...
// normalize hours
function __normalizeHour(ts: Timestamp) {
...
// normalize days
function __normalizeDay(ts: Timestamp) {
  __normalizeMonth(ts)
...
// normalize months
function __normalizeMonth(ts: Timestamp) {
  if (ts.month > MONTH_MAX) {
...
// normalize all
function __normalize(ts: Timestamp, type: string) {
  switch (type) {
    case 'minute':
 ...
 */
export function daysBetween(ts1: Timestamp, ts2: Timestamp) {
 ...
 * @param {Timestamp} ts2 The second {@link Timestamp}
 */
export function weeksBetween(ts1: Timestamp, ts2: Timestamp) {
